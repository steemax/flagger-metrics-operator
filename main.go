...
func init() {
	...
	utilruntime.Must(flaggerv1.AddToScheme(scheme))
...
func main() {
	...
	go func() {
		updater.UpdateInfoPeriodically()
	}()
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID: "8f32aedb.3rd.io",
	})
	...
	reconciler := controllers.NewTemplateReconciler(mgr)

	// Связываем реконсилер с менеджером
